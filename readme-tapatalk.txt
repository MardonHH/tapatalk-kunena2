...
- Kunena 2.0 Series Version 0.1.1 released

1.it is a beta version,support kunena 2.0.1/2.0.2
2.fixed some compatibility issues in different Joomla! version for example Joomla! 1.5.x/2.5.x
