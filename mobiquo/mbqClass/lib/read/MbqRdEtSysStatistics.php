...
Class MbqRdEtSysStatistics extends MbqBaseRdEtSysStatistics {
    ...
    public function initOMbqEtSysStatistics() {
        ...
        $arr = KunenaUserHelper::getOnlineCount();
        $oMbqEtSysStatistics->forumTotalOnline->setOriValue($arr['user'] + $arr['guest']);
        $oMbqEtSysStatistics->forumGuestOnline->setOriValue($arr['guest']);
